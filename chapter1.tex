...
\begin{proof}
    ...
    \end{equation}
    Let \( x_{0} \) denote an arbitrary set. Then by \eqref{eq:A-B-empty}, \( x_{0} \notin A \,\,{\land}\,\, x_{0} \notin B \).
    Thus, \( x_{0} \in A {\implies} x_{0} \in B \) and \( x_{0} \in B {\implies} x_{0} \in A \) are both vacuously true.
...
\begin{thm}[Restricted Comprehension]
    ...
    If \( \varphi \) is a \aref{dfn:first-order-language-construction-of-formulas}{formula} of some first-order language of set theory,
    then for any set \( A \), the set \( S \) such that \( \forall x \, \mleft[ x \in S {\iff} x \in A \,\,{\land}\,\, \varphi \mright] \) is unique.
\end{thm}

\begin{proof}
    Let \( S \) and \( S^{\prime} \) be sets such that,
    \begin{gather}
        \forall x \, \big[ x \in S \iff x \in A \,\,{\land}\,\, \varphi \big] \label{eq:S-satisfies-phi} \\
        \forall x \, \big[ x \in S^{\prime} \iff x \in A \,\,{\land}\,\, \varphi \big] \label{eq:S-prime-satisfies-phi}
    \end{gather}
    Note that the \nameref{axm:axiom-schema-of-specification} guarantees the existence of \( S \) and \( S^{\prime} \).
    Let \( x_{0} \) denote an arbitrary set. Suppose that \( x_{0} \in S \).
...
\begin{thm}
    ...
    If \( \varphi \) is a formula of some first-order language of set theory, then
    \begin{equation*}
...
\begin{proof}
    Let \( \varphi(x) \) be any first-order formula such that
    \begin{equation}
    ...
    from \eqref{eq:property-of-S}. By \aref{rule-of-inference:conjunction-elimination}{Conjunction Elimination}, we can infer \( \varphi(x_{0}) \).
    \begin{equation}
...
\noindent
\cref{thm:uniqueness-predicate-set,thm:sufficient-condition-for-unrestricted-comprehension}
