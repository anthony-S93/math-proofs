...
\begin{proof}
    ...
    an obvious contradiction. By Reductio ad Absurdum, we conclude that \( A = \emptyset \).
...
\begin{proof}
    Let \( A \) and \( B \) be arbitrary sets. First, observe that \( A - B = A - \mleft( A \intersect B \mright) \) by De Morgan's Law and also that
