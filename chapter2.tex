...
\begin{proof}
    ...
    \( \alpha \) and \( \beta \). If \( \orderedpair{\alpha}{\beta} \in g \), then \cref{dfn:restricted-functions} requires that \( \orderedpair{\alpha}{\beta} \in \restrictedfunctionsmall{f}{A} \) and \( \alpha \in B \). Since \( \orderedpair{\alpha}{\beta} \in \restrictedfunctionsmall{f}{A} \), \cref{dfn:restricted-functions} once again
    ...
    Since \( \orderedpair{\alpha}{\beta} \in f \) and \( \alpha \in A \,{\intersect}\, B\), we can apply \cref{dfn:restricted-functions} once again to conclude
    ...
    By \cref{dfn:restricted-functions}, it follows that \( \orderedpair{\alpha}{\beta} \in f \) and \( \alpha \in A \,{\intersect}\, B \).
    Clearly, \( \alpha \in A \) and \( \alpha \in B \) are both true.
    Since \( \orderedpair{\alpha}{\beta} \in f \) and \( \alpha \in A \), it follows immediately from \cref{dfn:restricted-functions}
...
\begin{proof}
    ...
    for some \( a \) and \( b \). Moreover, \cref{dfn:restricted-functions} also requires that \( a \in A \) and \( \orderedpair{a}{b} \in \mleft( f \union g \mright) \).
    ...
    If \( \orderedpair{c}{d} \in \restrictedfunctionsmall{f}{A} \), then clearly \( \orderedpair{c}{d} \in f \) and \( c \in A \) by \cref{dfn:restricted-functions}.
    ...
    But \( \orderedpair{c}{d} \in g \) implies \( \orderedpair{c}{d} \in f \union g \). Since \( c \in A \), it follows from \cref{dfn:restricted-functions}
