...
\begin{proof}
    ...
    \( I = \emptyset \). Thus, \( R = \emptyset \) by Reductio ad Absurdum.
    \begin{equation*}
        \therefore \, I = \emptyset \implies R = \emptyset
    \end{equation*}
    To prove the converse, suppose that \( R = \emptyset \). If \( I \neq \emptyset \), then
    there must exists some \( x_{0} \in I \). But \( I = \dom S \), so necessarily \( x_{0} \in \dom S \).
    ...
    Again, by Reductio ad Absurdum, \( I \) must be empty.
    \begin{equation*}
...
\begin{proof}
    ...
    \begin{equation*}
        \emptyset^\emptyset = \setbuilder{f}{\function{f}{\emptyset}{\emptyset}}
    \end{equation*}
