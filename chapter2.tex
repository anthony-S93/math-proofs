...
\begin{proof}
    ...
    \end{equation}
    By the Law of Excluded Middle, obviously, 
    \begin{equation*}
        a = b \lor a \neq b
    \end{equation*}
    ...
    Disjunctive Syllogism to \eqref{eq:for-curly-a}, we conclude that \( \mleft\{ a \mright\} = \mleft\{ c \mright\} \).
    \begin{equation*}
        \therefore \, a = c
    \end{equation*}
...
\begin{proof}
    ...
    by Disjunction Elimination that \( x_{0} \in \powerset{A} \). In other words, \( x_{0} \in \orderedpair{a}{b} \implies x_{0} \in \powerset{A} \)
    for any arbitrary \( x_{0} \). Thus, by Universal Generalization,
    \begin{equation*}
    ...
    \end{equation*}
    Since \( a \), \( b \), \( A \) are all arbitrary, the theorem follows by Universal Generalization.
\end{proof}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( x_{0} \) and \( y_{0} \) are arbitrary, we conclude by Universal Generalization that,
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( y_{0} \) is arbitrary, Universal Generalization yields,
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( y_{0} \) and \( x_{0} \) are arbitrary, Universal Generalization yields,
    \begin{equation*}
...
\begin{proof}
    ...
    is vacuously true. Since \( x_{0} \) is arbitrary, we infer by Universal Generalization,
    \begin{equation*}
    ...
    by \eqref{eq:restating-the-image-of-R-under-empty-in-terms-of-phi}. Since \( y_{0} \) is arbitrary, we conclude by Universal Generalization
    that,
    \begin{equation*}
...
\begin{thm}
    \label{thm:inverse-of-the-inverse-is-the-set-itself}
...
\begin{proof}
    ...
    Universal Instantiation on \cref{dfn:image-of-a-set-of-ordered-pairs} to obtain,
    \begin{equation}
    ...
    \end{equation}
    The laws of elementary logic (\cref{logic:grouping-conjuncts-into-quantified-statement-existential}) 
    ...
    \end{equation*}
    Using \cref{logic:grouping-conjuncts-into-quantified-statement-existential}, the formula becomes,
    \begin{equation*}
        y_{0} \in \Union T 
        \iff
        \exists z \, \Big( z \in S \land \exists t \, \mleft( t = \imageSet{R}{z} \land y_{0} \in t \mright) \Big)
    \end{equation*}
    By \cref{logic:using-existential-quantifier-to-express-the-fact-that-an-object-satisfies-a-predicate}, we have, 
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    Given that \( y_{0} \) is arbitrary, the theorem follows by Universal Generalization.
\end{proof}
...
\begin{proof}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    Universal Instantiation on the second conjunct of \eqref{eq:y0-belongs-to-RA-minus-RB} yields,
    \begin{equation*}
        x_{0} \in B \implies \orderedpair{x_{0}}{y_{0}} \notin R
    \end{equation*}
    Since \( \orderedpair{x_{0}}{y_{0}} \in R\), we conclude by Modus Tollens that \( x_{0} \notin B \). 
    \begin{equation*}
        \therefore \, \exists x \, \big[ x \in A \land x \notin B \land \orderedpair{x}{y_{0}} \in R \big]
    \end{equation*}
    By \eqref{eq:y0-belongs-to-R-A-minus-B}, it follows that \( y_{0} \in \imageSet{R}{A-B} \). By Universal Generalization
...
\begin{proof}
    ...
    \begin{equation*}
        y_{0} \in \imageSet{R}{A} \implies y_{0} \in \imageSet{R}{B}
    \end{equation*}
    Since \( y_{0} \) is arbitrary, we conclude by Universal Generalization that,
    \begin{equation*}
    ...
    \begin{equation*}
        \therefore \, A \subseteq B \implies \imageSet{R}{A} \subseteq \imageSet{R}{B} \qedhere
    \end{equation*}
\end{proof}
...
\begin{proof}
    ...
    \end{align*}
    Since \( x_{0} \) is arbitrary, the theorem follows by Universal Generalization and the \nameref{axm:axiom-of-extensionality}.
\end{proof}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( a \) and \( b \) are arbitrary, Universal Generalization yields,
    \begin{equation*}
...
\begin{proof}[Proof 1.]
    ...
    \end{equation*}
    Thus, by the Deduction Theorem, we derive,
    \begin{equation}
    ...
    \begin{equation*}
        ...
        \mleft( A \times B = \emptyset \mright)
    \end{equation*}
    Since \( A \) and \( B \) are arbitrary, the theorem follows by Universal Generalization.
\end{proof}
...
\begin{proof}[Proof 2.]
    ...
    then \( \Gamma(\orderedpair{\alpha}{\beta}) \) must hold by Universal Instantiation. By \eqref{eq:define-outer-predicate}, 
    this implies,
    \begin{equation*}
    ...
    \( \varphi(\alpha, \beta) \) must also be true by Modus Ponens. Since \( \alpha \) and \( \beta \)
    ...
    we have by Universal Generalization \( \forall a,b \, \mleft( x_{0} = \orderedpair{a}{b} \implies \varphi(a,b) \mright) \).
    In other words, \( \Gamma(x_{0}) \) holds. 

    \vspace{0.5cm}
    \noindent
    We have shown that \( \Gamma(x_{0}) \) follows from \( \forall a,b \, \varphi(a,b) \) regardless
    of whether \( x_{0} \) is an ordered pair. Since \( x_{0} \) is arbitrary, we can conclude by Universal Generalization that
    ...
    \end{equation}
    Using \cref{logic:grouping-disjuncts-into-quantified-statement-universal}, we can simplify \eqref{eq:A-cross-B-equals-empty-final-statement}
    even further.
    \begin{align*}
        \mleft( A \times B = \emptyset \mright) 
        &\iff 
...
\begin{proof}
    ...
    Thus, we infer \( x_{0} \in B \) by Modus Ponens. By the Deduction Theorem,
    \begin{equation*}
    ...
    \end{equation*}
    Since \( A \), \( B \), and \( S \) are arbitrary, the theorem follows from Universal Generalization.
\end{proof}
...
\begin{proof}
    ...
    \vspace{0.5cm}
    \noindent
    For the first equality, define the predicates \( \Gamma \) and \( \varphi \) as follows.
    \begin{align*}
        \Gamma(x) 
        &\coloneq 
    ...
    \end{align*}
    By \cref{thm:union-in-terms-of-logical-or,dfn:cartesian-product}, clearly,
    \begin{gather*}
        \forall x \, \Big( x \in \mleft( A \union B \mright) \times C \iff \Gamma(x)\Big)\\ 
        \forall x \, \Big( x \in \mleft( A \times C \mright) \union \mleft( B \times C \mright) \iff \varphi(x) \Big)
    \end{gather*}
    Let \( x_{0} \) be arbitrary. By definition,
    \begin{equation*}
        \begin{split}
            \Gamma(x_{0})
        ...
        \end{split}
    \end{equation*}
    Since \( x_{0} \) is arbitrary, we conclude by Univesal Generalization that \( \forall x \, \mleft( \Gamma(x) \iff \varphi(x) \mright) \).
    Thus,
    \begin{equation*}
        \forall x \, \Big( x \in \mleft( A \union B \mright) \times C \iff 
        \Gamma(x) \iff \varphi(x) \iff x \in \mleft( A \times C \mright) \union \mleft( B \times C \mright)\Big)
    \end{equation*}
    The first identity follows immediately from the \nameref{axm:axiom-of-extensionality}.

    \vspace{0.5cm}
    \noindent
    For the second equality, we define \( \Gamma \) and \( \varphi \) as follows:
    \begin{align*}
        \Gamma(x) 
        &\coloneq 
    ...
    \end{align*}
    By \cref{thm:intersection-in-terms-of-logical-and,dfn:cartesian-product}, clearly,
    \begin{gather*}
    ...
    \vspace{0.2cm}
    \noindent
    Having established the biconditional \( \Gamma(x_{0}) {\iff} \varphi(x_{0}) \), we conclude by Universal Generalization that,
    \begin{equation*}
        \forall x \, \mleft( \Gamma(x) \iff \varphi(x) \mright)
    \end{equation*}
    Therefore, 
    \begin{equation*}
        \forall x \, \Big( x \in \mleft( A \intersect B \mright) \times C \iff \Gamma(x) \iff \varphi(x) \iff x \in \mleft( A \times C \mright) \intersect \mleft( B \times C \mright)\Big)
    \end{equation*}
    The second equality follows readily from the \nameref{axm:axiom-of-extensionality}.

    \vspace{0.2cm}
    \noindent
    For the third equality, we define \( \Gamma \) and \( \varphi \) as follows:
    \begin{align*}
        \Gamma(x)
        &\coloneq
    ...
    \begin{equation*}
        ...
        \end{split}
    \end{equation*}
    It remains to prove that \( \forall x \, \mleft( \Gamma(x) \iff \varphi(x) \mright) \). Let \( x_{0} \) be an arbitrary object 
    ...
    \( \alpha \notin B \), it follows that \( a_{0} \notin B \). By Disjunction Introduction, we conclude \( a_{0} \notin B \lor b_{0} \notin C \).
    In other words, \( x_{0} = \orderedpair{a_{0}}{b_{0}} \implies \mleft( a_{0} \notin B \lor b_{0} \notin C \mright) \) for any arbitrary
    \( a_{0} \) and \( b_{0} \). By Universal Generalization, we have,
    \begin{equation*}
        \forall a \, \forall b \, \big[ x = \orderedpair{a}{b} \implies \mleft( a \notin B \lor b \notin C \mright) \big]
    \end{equation*}
    By Conjunction Introduction, it follows that,
    \begin{equation*}
        \exists a \, \exists b \, \big[ x_{0} = \orderedpair{a}{b} \land a \in A \land b \in C \big]
        \land 
    ...
    \begin{equation*}
        \alpha \notin B \lor \beta \notin C
    \end{equation*}
    But it has already been established that \( \beta \in C \), so by Disjunctive Syllogism, \( \alpha \notin B \) must be 
    ...
    \end{equation*}
    Thus the biconditional \( \Gamma(x_{0}) \iff \varphi(x_{0}) \) holds. Since \( x_{0} \) is arbitrary, we conclude
    \( \forall x \, \mleft( \Gamma(x) \iff \varphi(x) \mright) \) by Universal Generalization. The third equality is a direct
    consequence of \( \forall x \, \mleft( \Gamma(x) \iff \varphi(x) \mright) \).

    \vspace{0.5cm}
    \noindent
    The fourth equality can be proven using the first and third equalities.
    \begin{align*}
...
\begin{rem}
    The cartesian product is also \keyword{left-distributive}. This can be proven in the exact same way as above.
\end{rem}
...
\begin{dfn}[Arrow Notation]
    ...
    Let \( A \) and \( B \) be sets and \( f \) be a function. We use the notation
    \function{f}{A}{B} when \( \dom f = A \) and \( \ran f \subseteq B \).
    Informally, \function{f}{A}{B} can be read as ``\( f \) is a function on \( A \) into \( B \).''
\end{dfn}

\begin{dfn}[Functional Notation]
    \label{dfn:functional-notation}
    For any function \( f \), if \( \orderedpair{x}{y} \in f \) for some \( x \in \dom f \), then 
    \( y \) is the \keyword{value} of \( f \) at \( x \) and is denoted by \( f(x) \). 
...
\begin{dfn}[Surjection]
    ...
    The notation \surjection{f}{A}{B} reads, ``\( f \) is a function on \( A \) onto \( B \),'' or
...
\begin{dfn}[Compatibility]
    ...
    If \( F \) is a system of functions, then \( F \) is a \keyword{compatible} if and only if,
    \begin{equation*}
        \forall x \, 
...
\begin{proof}
    ...
    Since \( \alpha \) is arbitrary, we conclude by Universal Generalization that,
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    by \cref{dfn:function-basic}. Thus, \( y_{0} \) is unique. By the Deduction Theorem and Universal Generalization, we infer,
    \begin{equation}
    ...
    By Universal Instantiation of \eqref{eq:assumed-second-conjunct}, we have,
    \begin{equation*}
    ...
    \end{equation}
    Thus, by applying Existential Instantiation on \eqref{eq:re-express-uniqueness-equivalently}, we know that 
    ...
    and \( z_{0} \in B \), we conclude by Modus Ponens and \eqref{eq:mu-is-unique} that \( \mu = y_{0} = z_{0} \).
    We have just derived \( y_{0} = z_{0} \) from the supposition that 
    \( \orderedpair{x_{0}}{y_{0}} \in f \land \orderedpair{x_{0}}{z_{0}} \in f \). Thus, by the Deduction Theorem, we 
    conclude,
    \begin{equation*}
        \orderedpair{x_{0}}{y_{0}} \in f \land \orderedpair{x_{0}}{z_{0}} \in f \implies y_{0} = z_{0}
    \end{equation*}
    Since \( x_{0} \), \( y_{0} \), and \( z_{0} \) are arbitrary, Universal Generalization yields,
    \begin{equation}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    By Universal Generalization and \cref{dfn:subset}, necessarily \( \ran f \subseteq B \). Since \( f \) is a 
    ...
    we conclude by the Deduction Theorem,
    \begin{multline}
...
\begin{proof}
    ...
    \begin{equation*}
        \Big( \dom f = \dom g \Big) \land \forall x \, \Big( x \in \dom f \implies f(x) = g(x) \Big)
    \end{equation*}
    Since the statement was derived on the assumption that \( f = g \), we conclude by the Deduction Theorem that,
    \begin{equation}
    ...
    Applying Universal Instantiation on \eqref{eq:suppose-equal-values} yields,
    \begin{equation*}
        a_{0} \in \dom f \implies f(a_{0}) = g(a_{0})
    \end{equation*}
    Clearly \( a_{0} \in \dom f\), so \( f(a_{0}) = g(a_{0}) \) by Modus Ponens.
    ...
    \( f(a_{0}) = g(a_{0}) = b_{0} \) by Modus Ponens and \eqref{eq:suppose-equal-values}. In other words, \( x_{0} = \orderedpair{a_{0}}{b_{0}} \in f \).
    \begin{equation}
...
\begin{proof}
    ...
    \begin{equation*}
        ...
        y_{1} = y_{2}
    \end{equation*}
    Since \( x_{0} \), \( y_{1} \), and \( y_{2} \) are arbitrary, we have by Universal Generalization,
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    But \( f(y_{0}) = x_{0} = f(z_{0}) \), so by Modus Ponens, we infer \( y_{0} = z_{0} \). 
    \begin{equation*}
    ...
    \end{equation*}
    for any \( x_{1} \in \dom f \) and \( x_{2} \in \dom f \). By Universal Generalization,
    \begin{equation*}
        \forall x \, \forall y \, \Big[ x \in \dom f \land y \in \dom f \implies \Big( f(x) = f(y) \implies x = y \Big) \Big]
    \end{equation*}
...
\begin{cor}
    ...
    \cref{thm:inverse-of-the-inverse-is-the-set-itself}.
\end{cor}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( x_{1} \) and \( x_{2} \) are arbitrary, we conclude by Universal Generalization,
    \begin{equation*}
...
\begin{proof}
    ...
    \end{equation*}
    Since \( f(x_{0}) = y_{0} = f(x_{r}) \), \( x_{0} = x_{r} \) follows by Modus Ponens. Since \( x_{r} = x_{0} \) and \( x_{0} \in z_{0} \),
    it follows that \( x_{r} \in z_{0} \) as well. In other words,
    \begin{equation*}
        \begin{aligned}
        ...
        \end{aligned}
    \end{equation*}
    Since \( z_{0} \) is arbitrary, we conclude by Universal Generalization that,
    \begin{equation*}
    ...
    the initial assumption \( y_{0} \in \Intersect T \). Therefore, we can conclude by the Deduction Theorem that,
    \begin{equation*}
        \begin{aligned}
        ...
        \end{aligned}
    \end{equation*}
    By Universal Generalization and \cref{dfn:subset}, it follows that \( \Intersect T \subseteq \imageSet{f}{\Intersect S} \)
...
\begin{proof}
    ...
    \end{equation*}
    Thus, \( \beta = x_{0} \) by Modus Ponens. But if \( \beta = x_{0} \), then \( \beta \notin B \), 
    an obvious contradiction. 
    Thus, we conclude by Reductio Ad Absurdum that the supposition \( \orderedpair{\beta}{y_{0}} \in f \)
    must be false. And by the Deduction Theorem, we infer,
    \begin{equation*}
        \beta \in B \implies \orderedpair{\beta}{y_{0}} \notin f
    \end{equation*}
    Since \( \beta \) is arbitrary, it follows from Universal Generalization that,
    \begin{equation*}
        \forall x \, \big( x \in B \implies \orderedpair{x}{y_{0}} \notin f \big)
    \end{equation*}
    ...
    \begin{equation*}
        ...
        \end{aligned}
    \end{equation*}
    By Universal Generalization and \cref{dfn:subset}, it follows that \( \imageSet{f}{A-B} \subseteq \imageSet{f}{A} - \imageSet{f}{B} \).
...
\begin{proof}
    ...
    \end{equation*}
    And by \cref{dfn:symmetric-difference}, we have,
    \begin{equation*}
        \imageSet{f}{A \symdiff B} = \imageSet{f}{A} \symdiff \imageSet{f}{B} \qedhere
    \end{equation*}
\end{proof}
...
\begin{proof}
    ...
    And by \eqref{eq:f-and-g-have-the-same-values-where-their-domains-intersect}, we infer,
    \begin{equation*}
        f(x_{0}) = y_{0} = g(x_{0}) = z_{0}
    \end{equation*}
    By the Deduction Theorem,
    \begin{equation*}
        \Big( \orderedpair{x_{0}}{y_{0}} \in \Union F \land \orderedpair{x_{0}}{z_{0}} \in \Union F \Big) \implies y_{0} = z_{0}
    \end{equation*}
    Since \( x_{0} \), \( y_{0} \), and \( z_{0} \) are arbitrary, \eqref{eq:Union-F-has-unique-first-coordinate} follows from 
    ...
    \end{align*}
    The equality follows immediately by Universal Generalization and the \nameref{axm:axiom-of-extensionality}.
\end{proof}
...
\vspace{0.5cm}
\noindent
Now we will prove some theorems involving indexed systems of sets.
\begin{thm}
...
\begin{proof}
    ...
    By the definition of \( S \), it follows that \( y_{0} = x_{0} = z_{0} \). By Universal Generalization,
    \begin{equation*}
...
\begin{proof}
    ...
    Since \( f \) is arbitrary, we infer by Universal Generalization,
    \begin{equation*}
...
\begin{proof}
    ...
    and since \( S_{i} \in R \), it follows that \( x_{0} \in \Union R \). By the Deduction Theorem, 
    we conclude,
    \begin{equation*}
...
\begin{thm}
    ...
    If \( A \) and \( I \) are sets and \surjection{S}{I}{\mleft\{ A \mright\}}, then 
    \begin{equation*}
...
\begin{proof}
    Let \( A \) and \( I \) be sets. Let \( S \) be a function that indexes the singleton \( \mleft\{ A \mright\} \). That is,
    \surjection{S}{I}{\mleft\{ A \mright\}}. By \cref{dfn:product-of-indexed-system-of-sets,thm:existence-of-the-product-of-an-indexed-system-of-sets},
    ...
    Thus, \eqref{eq:express-the-union-of-singleton-using-first-order-logic} becomes,
    \begin{equation}
    ...
    \end{equation*}
    Since \( i \) is arbitrary, Universal Generalization yields,
    \begin{equation*}
    ...
    \( f \in \prod_{i \,\in\, S_{i}} \) by \eqref{eq:the-product-of-S-in-set-builder-notation-final-form}. Thus,
    for any \( f \),
    \begin{equation*}
            f \in A^{I} \iff f \in \prod_{i \,\in\, I} S_{i}
    \end{equation*}
    The equality follows immediately from Universal Generalization and the \nameref{axm:axiom-of-extensionality}.
\end{proof}
