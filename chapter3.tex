...
\begin{dfn}[Inductive Set]
    ...
    \begin{enumerate}[noitemsep,label=\texttt{\textup{(\alph*)}}]
        \item \( \emptyset \in I \)
...
\vspace{0cm}
\begin{enumerate}[label=\texttt{\textup{(\alph*)}}]
...
\begin{proof}
    ...
    we have shown that \( \tuple{E_{1},P} \in f \land \tuple{E_{2},P} \in f \implies E_{1} = E_{2} \). Thus, \( f \)
