...
\begin{proof}
    ...
    Note that \( \smallsubscript{+}{W} \) is the vector addition of \( \mathcal{V} \) with its domain \aref{dfn:restricted-function}{restricted} to \( W^{2} \).
...
\begin{proof}
    ...
    \aref{dfn:restricted-function}{restricted} to \( L^{2} \) and \( \prod \tuple{\abs{\mathcal{F}}, L} \) respectively.
