\chapter{The Axioms of Set Theory} \label{ch:zfc-axioms}
...
\begin{axm}[Axiom of Extensionality]
    ...
    \begin{equation*}
        \forall A,B \, \Big[\, \forall x \left( x \in A \iff x \in B \right) \implies A = B \,\Big]
    \end{equation*}
\end{axm}

\begin{axm}[Axiom of Pairing]
    \label{axm:axiom-of-pairing}
    For any objects \( a \) and \( b \), there exists a set \( S \) such that \( S \) contains exactly \( a \) and \( b \). 
    \begin{equation*}
        \forall a, b \, \exists S \, \forall x \Big[ x \in S \iff (x = a \lor x = y) \Big]
    \end{equation*}
\end{axm}

\begin{axm}[Axiom Schema of Specification]
    \label{axm:axiom-schema-of-specification}
    Given any predicate \( \varphi \) and any existing set \( A \), there exists a set \( S \)
    such that \( x \in S \) if and only if \( x \in A \land \varphi(x) \).
    \begin{equation*}
        \forall A \, \exists S \, \forall x \Big[\, x \in S \iff x \in A \land \varphi(x) \,\Big]
    \end{equation*}
\end{axm}
...
\begin{axm}[Axiom of Union]
    ...
    \begin{equation*}
        \forall A \, \exists U \, \forall x \Big[\, x \in U \iff  \exists S \,{\in}\, A \, \big(x \in S\big) \,\Big] 
    \end{equation*}
\end{axm}
...
\begin{axm}[Axiom of Infinity]
    ...
    \begin{equation*}
        \exists I \Big[ \emptyset \in I \land \forall x \, \big( x \in I \implies x \cup \{x\} \in I\big)\Big]
    \end{equation*}
\end{axm}
