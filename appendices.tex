...
\end{equation}
We can verify that \( s^{\mathfrak{A}} \) as defined in \eqref{eq:interpreted-s-implicit} is the same function one would obtain
if one were to interpret the term \( h(f(x), f(y), g(x, z)) \) directly in the context of \( \mathfrak{A} \).
