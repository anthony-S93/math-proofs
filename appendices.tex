...
\begin{dfn}
    ...
    \begin{enumerate}[topsep=2pt,label=\textup{\texttt{(\alph*)}}]
        \item \( t_{1} = t_{2} \) where \( t_{1} \) and \( t_{2} \) are \( \mathcal{L} \)-terms
        \item \( P^{\mathcal{L}}_{i}(t_{0}, \dots, t_{n-1}) \) for some \( i \in \dom P^{\mathcal{L}} \) where \( n = \Pi^{\mathcal{L}}(i) \)
            and \( t_{0},\dots,t_{n-1} \) are \( \mathcal{L} \)-terms
    \end{enumerate}
\end{dfn}
...
\vspace{0.3cm}
\noindent
Nevertheless, there are situations in which explicit definitions of subterms are neither practical nor viable; e.g., in recursive definitions of terms.
